...
extension View {
    public func onLoad(_ action: @escaping () -> Void) -> some View {
        self.modifier(OnLoadModifier(action: action))
    }

    public func onAppearOnce(_ action: @escaping () -> Void) -> some View {
        self.modifier(OnAppearModifier(action: action))
    }

    public func onDisappearOnce(_ action: @escaping () -> Void) -> some View {
